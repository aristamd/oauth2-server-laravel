...
class IntergyGrant extends AbstractGrant
{
    ...
    */
    ...
    public function completeFlow()
    {
        ...
        $identity = $this->server->getRequest()->request->get(self::SSO_USER_LOGON, null);
        if (is_null($identity))
        {
        ...
        $signature = $this->server->getRequest()->request->get(self::SSO_SECURITY_DIGEST, null);
        ...
        // Intergy extra credential (PILOT-4156)
        $organization = $this->server->getRequest()->request->get(self::SSO_PRACTICE_ID, null);
